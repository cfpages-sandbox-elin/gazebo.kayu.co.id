---
article_id: GZK-01-02
title: "Gazebo Kayu vs Bambu: Perbedaan Perawatan dan Karakter"
slug: "gazebo-kayu-vs-bambu"
...
date_modified: null
parent_topic: GZK-01
primary_intent: "Compare timber and bamboo"
reader_community: "Kayu.co.id"
reader_address: "Kawan Kayu.co.id"
final_route: "/artikel/gazebo-kayu-vs-bambu.html"
...
# Gazebo Kayu vs Bambu: Perbedaan Perawatan dan Karakter

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Gazebo Kayu vs Bambu: Perbedaan Perawatan dan Karakter”
...
- **Primary intent:** Compare timber and bamboo
...
- **Scope boundary:** Two organic materials only
- **Final public route:** `/artikel/gazebo-kayu-vs-bambu.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Gazebo Kayu vs Bambu: Perbedaan Perawatan dan Karakter**.
...
- **Exact Markdown to insert:** `![Ilustrasi bambu 2](/wp-content/uploads/2023/01/bambu-2.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `bambu 2` as relevant content media; no pixels were inspected.
...
- `GZK-01-03` → `/artikel/gazebo-kayu-vs-besi.html` — Gazebo Kayu vs Besi untuk Area Luar Ruang
...
- **Tie back to this article:** Keep the explanation specific to “Gazebo Kayu vs Bambu: Perbedaan Perawatan dan Karakter”.
