---
article_id: GZK-12-05
title: "Memperbaiki Retak, Cekung, dan Kerusakan Lokal Kayu"
slug: "triase-kerusakan-lokal-gazebo"
...
date_modified: null
parent_topic: GZK-12
primary_intent: "Decide repair escalation"
reader_community: "Kayu.co.id"
reader_address: "Teman Kayu.co.id"
final_route: "/artikel/triase-kerusakan-lokal-gazebo.html"
...
# Memperbaiki Retak, Cekung, dan Kerusakan Lokal Kayu

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Memperbaiki Retak, Cekung, dan Kerusakan Lokal Kayu”
...
- **Primary intent:** Decide repair escalation
...
- **Scope boundary:** Triage only; load-bearing repair needs designer
- **Final public route:** `/artikel/triase-kerusakan-lokal-gazebo.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memperbaiki Retak, Cekung, dan Kerusakan Lokal Kayu**.
...
- **Exact Markdown to insert:** `![Ilustrasi gazebo 14](/wp-content/uploads/2023/02/gazebo-14.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `gazebo 14` as relevant content media; no pixels were inspected.
...
- `GZK-12-04` → `/artikel/kapan-refinishing-gazebo.html` — Kapan Finishing Gazebo Perlu Diperbarui?
...
- **Tie back to this article:** Keep the explanation specific to “Memperbaiki Retak, Cekung, dan Kerusakan Lokal Kayu”.
