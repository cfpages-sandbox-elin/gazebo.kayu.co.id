---
article_id: GZK-01-03
title: "Gazebo Kayu vs Besi untuk Area Luar Ruang"
slug: "gazebo-kayu-vs-besi"
description: "Decide whether a timber gazebo fits and define the project need"
status: outline
publication_date: "2025-10-19"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: GZK-01
primary_intent: "Compare timber and steel"
reader_community: "Kayu.co.id"
reader_address: "Sobat Kayu.co.id"
final_route: "/artikel/gazebo-kayu-vs-besi.html"
...
# Gazebo Kayu vs Besi untuk Area Luar Ruang

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Gazebo Kayu vs Besi untuk Area Luar Ruang”
- **Reader and situation:** Decide whether a timber gazebo fits and define the project need
- **Reader outcome:** Decide whether a timber gazebo fits and define the project need
- **Primary intent:** Compare timber and steel
...
- **Scope boundary:** Selection comparison; no structural claims
- **Final public route:** `/artikel/gazebo-kayu-vs-besi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Gazebo Kayu vs Besi untuk Area Luar Ruang**.
...
- **Exact Markdown to insert:** `![Ilustrasi besi](/wp-content/uploads/2023/01/besi.jpeg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `besi` as relevant content media; no pixels were inspected.
...
- **Purpose for this article:** Freeze the verified editorial scope for `gazebo.kayu.co.id` and prevent family research from overriding this project's actual catalog boundaries.
...
- **TOPIC-GATE:** G-02, G-03, G-06, G-09, G-12, G-13
...
- `/gazebo-kayu-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/gazebo-kayu-wonosobo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/gazebo-kayu-wonogiri` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/gazebo-kayu-tulungagung` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/gazebo-kayu-tuban` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/gazebo-kayu-trenggalek` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `GZK-01-01` → `/artikel/brief-proyek-gazebo-kayu.html` — Cara Menyusun Brief Gazebo Kayu Sebelum Meminta Penawaran
- `GZK-01-02` → `/artikel/gazebo-kayu-vs-bambu.html` — Gazebo Kayu vs Bambu: Perbedaan Perawatan dan Karakter
- `GZK-01-04` → `/artikel/gazebo-kayu-vs-beton.html` — Gazebo Kayu vs Beton: Bobot, Tampilan, dan Perubahan di Masa Depan
- `GZK-01-05` → `/artikel/gazebo-permanen-vs-knock-down.html` — Gazebo Permanen atau Knock-Down: Mana yang Sesuai?
...
- **Tie back to this article:** Keep the explanation specific to “Gazebo Kayu vs Besi untuk Area Luar Ruang”.
